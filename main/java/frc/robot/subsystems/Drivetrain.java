...
public class Drivetrain extends SubsystemBase {
	...
	private final VictorSPX backLeft = new VictorSPX(Constants.BACK_LEFT_VICTORMAX_ID, MotorType.kBrushless);
	private final VictorSPX frontLeft = new VictorSPX(Constants.FRONT_LEFT_VICTORMAX_ID, MotorType.kBrushless);
	private final VictorSPX backRight = new VictorSPX(Constants.BACK_RIGHT_VICTORMAX_ID, MotorType.kBrushless);
	private final VictorSPX frontRight = new VictorSPX(Constants.FRONT_RIGHT_VICTORMAX_ID, MotorType.kBrushless);
